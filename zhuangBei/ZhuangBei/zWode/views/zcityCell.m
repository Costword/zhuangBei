...
//        NSString * thirdName = [zEducationRankTypeInfo shareInstance].userInfoModel.suoShuGsName;
//        if (thirdName == nil) {
//            thirdName = @"";
//        }
//        self.upModel.suoShuGsName = thirdName;
//        self.inputTextFild.text = [NSString stringWithFormat:@"%@",thirdName];
//
//        [self changeMyUpModel:nil];
//        return;
//    }
...
//                weakSelf.inputTextFild.text = [NSString stringWithFormat:@"%@",leixing];
//                [weakSelf changeMyUpModel:nil];
//                return YES;
//        })
//        .LeeShow();
