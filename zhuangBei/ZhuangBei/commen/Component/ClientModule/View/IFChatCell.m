...
- (void)createUI {
    ...
    if (_layoutType == IFChatCellStyleLeft || _layoutType == IFChatCellStyleLeftAndNoBG) {
        ...
        label.textAlignment = label2.textAlignment = label3.textAlignment = NSTextAlignmentLeft;
    } else {
        label.textAlignment = label2.textAlignment = label3.textAlignment = NSTextAlignmentRight;
        [imageView mas_remakeConstraints:^(MASConstraintMaker *make) {
