...
- (CGRect)screenFrame {
  return CGRectMake(self.screenViewX, self.screenViewY, SCREEN_WIDTH, SCREEN_HEIGHT);
}
...
+ (UILabel *)labelWithfontSize:(CGFloat)fontSize
              textAlignment:(NSTextAlignment)alignment
                          text:(NSString *)text textColor:(UIColor *)tColor lineStyle:(NSLineBreakMode)style cornerRadius:(CGFloat)radius
{
