...
- (void)setUpYMDateDic{
    ...
    for (NSInteger i = yearintger-100; i<= yearintger; i++) {
...
- (void)sureButtonClicked:(UIButton *)sender{
    ...
    _selectedYearTitle = [_selectedYearTitle substringToIndex:_selectedYearTitle.length-1];
    _selectedMonthTitle = [_selectedMonthTitle substringToIndex:_selectedMonthTitle.length-1];
    _selectedDayTitle = [_selectedDayTitle substringToIndex:_selectedDayTitle.length-1];
    if (self.pickViewDelegate &&
